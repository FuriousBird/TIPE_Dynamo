...
MY_TEXT = tp.Text("This is a text.\nIt can be multi-line.\nIt can be centered?", font_size=20)
MY_TEXT.set_topleft(100,100)
...
while loop.playing:
    ...
    ... #do what you want, it's your code
    loop.update(blit_before_gui, events=events, mouse_rel=mouse_rel) #refresh gui
    bis_up.update(blit_before_gui, events=events, mouse_rel=mouse_rel)
    pygame.display.flip()
